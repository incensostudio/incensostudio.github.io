...
(() => {
  ...
  const NAV = '<a href="/shop">Shop</a>' +
    ...
    '<div class="nav-menu" id="services-menu" role="menu"><a href="/hair" role="menuitem">Hair</a><a href="/nails" role="menuitem">Nails</a><a href="/makeup" role="menuitem">Make-up</a><a href="/brows-lashes" role="menuitem">Brows &amp; Lashes</a></div></div>' +
    '<a href="/work">Our Work</a><a href="/space">The Space</a><a href="/gift">Gift</a>';
  const header = document.createElement('header');
  header.className = 'topbar';
  header.innerHTML = '<div class="tb-l"><a class="tb-cart tb-cart-left" href="/cart" aria-label="Cart">' + CART_SVG + '</a>' +
    ...
    '<div class="tb-r"><a class="tb-book" href="/book">Book</a><a class="tb-cart" href="/cart" aria-label="Cart">' + CART_SVG + '</a>' +
    '<a class="tb-cart tb-account" href="/account" data-account-btn aria-label="Sign in"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="8" r="3.4"></circle><path d="M5 19.5c1.3-3.2 4-4.8 7-4.8s5.7 1.6 7 4.8"></path></svg></a>' +
  ...
  footer.innerHTML = '<div class="news-row"><p class="news-line">Be first to hear — new services, quiet offers, studio news.</p>' +
    ...
    '<div class="f-col"><a href="/terms">Terms &amp; Conditions</a><a href="/shipping">Shipping</a><a href="/privacy">Privacy</a></div>' +
  ...
  document.querySelectorAll('.topbar a[href], .mobile-nav a[href]').forEach((a) => {
    const t = (a.getAttribute('href') || '').replace(/^\//, '').split('?')[0].split('#')[0].replace(/\.html$/, '');
